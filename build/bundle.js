    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			h40 = element("h4");
    			h40.textContent = "Tesla";
    			t6 = space();
    			h50 = element("h5");
    			h50.textContent = "Tesla dashboard screen";
    			t8 = space();
    			a0 = element("a");
    			p0 = element("p");
    			p0.textContent = "view project";
    			t10 = space();
    			div5 = element("div");
    			div3 = element("div");
    			img1 = element("img");
    			...
    			t13 = space();
    			h41 = element("h4");
    			h41.textContent = "Automotive";
    			t15 = space();
    			h51 = element("h5");
    			h51.textContent = "A music player concept";
    			t17 = space();
    			a1 = element("a");
    			p1 = element("p");
    			p1.textContent = "view project";
    			t19 = space();
    			div8 = element("div");
    			div6 = element("div");
    			img2 = element("img");
    			...
    			t22 = space();
    			h42 = element("h4");
    			h42.textContent = "RESQ";
    			t24 = space();
    			h52 = element("h5");
    			h52.textContent = "Webapp redesign";
    			t26 = space();
    			a2 = element("a");
    			p2 = element("p");
    			p2.textContent = "view project";
    			attr_dev(h2, "class", "svelte-1472c6q");
    			...
    			attr_dev(img0, "class", "svelte-1472c6q");
    			add_location(img0, file$5, 14, 12, 246);
    			attr_dev(div0, "class", "img svelte-1472c6q");
    			add_location(div0, file$5, 13, 12, 215);
    			attr_dev(h30, "class", "svelte-1472c6q");
    			add_location(h30, file$5, 18, 16, 399);
    			attr_dev(h40, "class", "svelte-1472c6q");
    			add_location(h40, file$5, 19, 16, 428);
    			attr_dev(h50, "class", "svelte-1472c6q");
    			add_location(h50, file$5, 20, 16, 460);
    			attr_dev(p0, "class", "svelte-1472c6q");
    			add_location(p0, file$5, 22, 20, 543);
    			attr_dev(a0, "href", "/");
    			attr_dev(a0, "class", "svelte-1472c6q");
    			add_location(a0, file$5, 21, 16, 509);
    			attr_dev(div1, "class", "title svelte-1472c6q");
    			add_location(div1, file$5, 17, 12, 362);
    			attr_dev(div2, "class", "card svelte-1472c6q");
    			add_location(div2, file$5, 12, 8, 183);
    			if (img1.src !== (img1_src_value = "/musicui.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "RESQ UI/UX by Prasad Jadhav");
    			attr_dev(img1, "class", "svelte-1472c6q");
    			add_location(img1, file$5, 30, 12, 712);
    			attr_dev(div3, "class", "img svelte-1472c6q");
    			add_location(div3, file$5, 29, 12, 681);
    			attr_dev(h31, "class", "svelte-1472c6q");
    			add_location(h31, file$5, 34, 16, 843);
    			attr_dev(h41, "class", "svelte-1472c6q");
    			add_location(h41, file$5, 35, 16, 872);
    			attr_dev(h51, "class", "svelte-1472c6q");
    			add_location(h51, file$5, 36, 16, 909);
    			attr_dev(p1, "class", "svelte-1472c6q");
    			add_location(p1, file$5, 38, 20, 992);
    			attr_dev(a1, "href", "/");
    			attr_dev(a1, "class", "svelte-1472c6q");
    			add_location(a1, file$5, 37, 16, 958);
    			attr_dev(div4, "class", "title svelte-1472c6q");
    			add_location(div4, file$5, 33, 12, 806);
    			attr_dev(div5, "class", "card svelte-1472c6q");
    			add_location(div5, file$5, 27, 8, 635);
    			if (img2.src !== (img2_src_value = "/resq3.png")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "RESQ UI/UX by Prasad Jadhav");
    			attr_dev(img2, "class", "svelte-1472c6q");
    			add_location(img2, file$5, 46, 12, 1172);
    			attr_dev(div6, "class", "img svelte-1472c6q");
    			add_location(div6, file$5, 45, 12, 1141);
    			attr_dev(h32, "class", "svelte-1472c6q");
    			add_location(h32, file$5, 50, 16, 1301);
    			attr_dev(h42, "class", "svelte-1472c6q");
    			add_location(h42, file$5, 51, 16, 1330);
    			attr_dev(h52, "class", "svelte-1472c6q");
    			add_location(h52, file$5, 52, 16, 1361);
    			attr_dev(p2, "class", "svelte-1472c6q");
    			add_location(p2, file$5, 54, 20, 1437);
    			attr_dev(a2, "href", "/");
    			attr_dev(a2, "class", "svelte-1472c6q");
    			add_location(a2, file$5, 53, 16, 1403);
    			attr_dev(div7, "class", "title svelte-1472c6q");
    			add_location(div7, file$5, 49, 12, 1264);
    			attr_dev(div8, "class", "card svelte-1472c6q");
    			add_location(div8, file$5, 43, 8, 1095);
    			attr_dev(div9, "class", "cardwrapper svelte-1472c6q");
    			add_location(div9, file$5, 10, 4, 146);
    			attr_dev(section, "class", "projects svelte-1472c6q");
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "gradient svelte-emb7nq");
    			add_location(h1, file$3, 13, 8, 258);
    			add_location(br, file$3, 16, 34, 352);
    			attr_dev(p, "class", "svelte-emb7nq");
    			add_location(p, file$3, 16, 8, 326);
    			attr_dev(div0, "class", "hero-text svelte-emb7nq");
    			add_location(div0, file$3, 12, 8, 224);
    			attr_dev(div1, "class", "arrow-down svelte-emb7nq");
    			add_location(div1, file$3, 19, 12, 463);
    			attr_dev(div2, "class", "arrow-container svelte-emb7nq");
    			add_location(div2, file$3, 18, 8, 420);
    			attr_dev(section, "class", "hero svelte-emb7nq");
    			add_location(section, file$3, 11, 4, 192);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-dwrx6p");
    			add_location(span, file$1, 7, 8, 109);
    			attr_dev(p0, "class", "svelte-dwrx6p");
    			add_location(p0, file$1, 6, 4, 76);
    			attr_dev(div0, "class", "text svelte-dwrx6p");
    			add_location(div0, file$1, 5, 4, 52);
    			attr_dev(p1, "class", "orange svelte-dwrx6p");
    			add_location(p1, file$1, 11, 8, 181);
    			attr_dev(div1, "class", "text svelte-dwrx6p");
    			add_location(div1, file$1, 10, 5, 153);
    			attr_dev(div2, "class", "version svelte-dwrx6p");
