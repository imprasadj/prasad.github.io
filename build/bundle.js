...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			li3 = element("li");
    			a6 = element("a");
    			a6.textContent = "resume";
    			t17 = space();
    			a7 = element("a");
    			a7.textContent = "contact";
    			attr_dev(h3, "class", "logo svelte-1sy794s");
    			add_location(h3, file$5, 16, 4, 260);
    			attr_dev(a0, "href", "/");
    			attr_dev(a0, "class", "svelte-1sy794s");
    			add_location(a0, file$5, 19, 16, 356);
    			attr_dev(li0, "class", "svelte-1sy794s");
    			add_location(li0, file$5, 19, 12, 352);
    			attr_dev(a1, "href", "#projects");
    			attr_dev(a1, "class", "svelte-1sy794s");
    			add_location(a1, file$5, 20, 16, 400);
    			attr_dev(li1, "class", "svelte-1sy794s");
    			add_location(li1, file$5, 20, 12, 396);
    			attr_dev(a2, "href", "/");
    			attr_dev(a2, "class", "svelte-1sy794s");
    			add_location(a2, file$5, 21, 16, 451);
    			attr_dev(li2, "class", "svelte-1sy794s");
    			add_location(li2, file$5, 21, 12, 447);
    			attr_dev(ul, "class", "nav-links svelte-1sy794s");
    			add_location(ul, file$5, 18, 8, 316);
    			add_location(nav, file$5, 17, 4, 301);
    			attr_dev(a3, "class", "contactbtn svelte-1sy794s");
    			attr_dev(a3, "href", "/");
    			add_location(a3, file$5, 24, 4, 511);
    			attr_dev(div0, "class", "menu svelte-1sy794s");
    			add_location(div0, file$5, 25, 4, 559);
    			attr_dev(header, "class", "svelte-1sy794s");
    			add_location(header, file$5, 15, 0, 246);
    			attr_dev(div1, "class", "close svelte-1sy794s");
    			add_location(div1, file$5, 31, 4, 713);
    			attr_dev(a4, "href", "/");
    			attr_dev(a4, "class", "svelte-1sy794s");
    			add_location(a4, file$5, 35, 8, 868);
    			attr_dev(a5, "href", "#projects");
    			attr_dev(a5, "class", "svelte-1sy794s");
    			add_location(a5, file$5, 36, 8, 899);
    			attr_dev(a6, "href", "/");
    			attr_dev(a6, "class", "svelte-1sy794s");
    			add_location(a6, file$5, 37, 12, 941);
    			attr_dev(li3, "class", "svelte-1sy794s");
    			add_location(li3, file$5, 37, 8, 937);
    			attr_dev(a7, "href", "/");
    			attr_dev(a7, "class", "svelte-1sy794s");
    			add_location(a7, file$5, 38, 8, 978);
    			attr_dev(div2, "class", "overlay-content svelte-1sy794s");
    			add_location(div2, file$5, 34, 4, 829);
    			attr_dev(div3, "id", "mobile-menu");
    			attr_dev(div3, "class", "overlay svelte-1sy794s");
    			add_location(div3, file$5, 30, 0, 669);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div2 = element("div");
    			div1 = element("div");
    			attr_dev(h1, "class", "gradient svelte-1a1m04s");
    			...
    			add_location(h1, file$4, 19, 8, 308);
    			add_location(br, file$4, 23, 34, 614);
    			...
    			attr_dev(p, "class", "svelte-1a1m04s");
    			add_location(p, file$4, 22, 8, 474);
    			attr_dev(div0, "class", "hero-text svelte-1a1m04s");
    			add_location(div0, file$4, 18, 8, 273);
    			attr_dev(div1, "class", "arrow-down svelte-1a1m04s");
    			add_location(div1, file$4, 27, 12, 832);
    			attr_dev(div2, "class", "arrow-container svelte-1a1m04s");
    			...
    			add_location(div2, file$4, 26, 8, 688);
    			attr_dev(section, "class", "hero svelte-1a1m04s");
    			add_location(section, file$4, 16, 4, 231);
    			attr_dev(div3, "id", "hero-page");
    			attr_dev(div3, "class", "svelte-1a1m04s");
    			add_location(div3, file$4, 13, 0, 188);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-ndunkd");
    			add_location(h2, file$3, 16, 4, 316);
    			attr_dev(h10, "class", "svelte-ndunkd");
    			add_location(h10, file$3, 23, 16, 572);
    			attr_dev(h11, "class", "svelte-ndunkd");
    			add_location(h11, file$3, 24, 16, 601);
    			attr_dev(h30, "class", "svelte-ndunkd");
    			add_location(h30, file$3, 25, 16, 633);
    			attr_dev(a0, "href", "/");
    			attr_dev(a0, "class", "svelte-ndunkd");
    			add_location(a0, file$3, 26, 16, 671);
    			attr_dev(div0, "class", "text svelte-ndunkd");
    			attr_dev(div0, "data-aos", "fade-up");
    			attr_dev(div0, "data-aos-duration", "500");
    			attr_dev(div0, "data-aos-anchor-placement", "bottom-bottom");
    			add_location(div0, file$3, 22, 12, 451);
    			attr_dev(div1, "class", "textcontainer svelte-ndunkd");
    			add_location(div1, file$3, 21, 8, 410);
    			attr_dev(div2, "class", "container1 svelte-ndunkd");
    			add_location(div2, file$3, 20, 4, 376);
    			attr_dev(h12, "class", "svelte-ndunkd");
    			add_location(h12, file$3, 33, 16, 950);
    			attr_dev(h13, "class", "svelte-ndunkd");
    			add_location(h13, file$3, 34, 16, 979);
    			attr_dev(h31, "class", "svelte-ndunkd");
    			add_location(h31, file$3, 35, 16, 1011);
    			attr_dev(a1, "href", "/");
    			attr_dev(a1, "class", "svelte-ndunkd");
    			add_location(a1, file$3, 36, 16, 1049);
    			attr_dev(div3, "class", "text svelte-ndunkd");
    			attr_dev(div3, "data-aos", "fade-up");
    			attr_dev(div3, "data-aos-duration", "500");
    			attr_dev(div3, "data-aos-anchor-placement", "bottom-bottom");
    			add_location(div3, file$3, 32, 12, 829);
    			attr_dev(div4, "class", "textcontainer svelte-ndunkd");
    			add_location(div4, file$3, 31, 8, 788);
    			attr_dev(div5, "class", "container2 svelte-ndunkd");
    			add_location(div5, file$3, 30, 4, 754);
    			attr_dev(h14, "class", "svelte-ndunkd");
    			add_location(h14, file$3, 43, 16, 1328);
    			attr_dev(h15, "class", "svelte-ndunkd");
    			add_location(h15, file$3, 44, 16, 1357);
    			attr_dev(h32, "class", "svelte-ndunkd");
    			add_location(h32, file$3, 45, 16, 1388);
    			attr_dev(a2, "href", "/");
    			attr_dev(a2, "class", "svelte-ndunkd");
    			add_location(a2, file$3, 46, 16, 1426);
    			attr_dev(div6, "class", "text svelte-ndunkd");
    			attr_dev(div6, "data-aos", "fade-up");
    			attr_dev(div6, "data-aos-duration", "500");
    			attr_dev(div6, "data-aos-anchor-placement", "bottom-bottom");
    			add_location(div6, file$3, 42, 12, 1207);
    			attr_dev(div7, "class", "textcontainer svelte-ndunkd");
    			add_location(div7, file$3, 41, 8, 1166);
    			attr_dev(div8, "class", "container3 svelte-ndunkd");
    			add_location(div8, file$3, 40, 4, 1132);
    			attr_dev(section, "class", "projects svelte-ndunkd");
    			attr_dev(section, "id", "projects");
    			attr_dev(section, "data-aos", "fade-in");
    			add_location(section, file$3, 15, 0, 251);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-19f0v85");
    			add_location(span, file$1, 7, 8, 109);
    			attr_dev(p0, "class", "svelte-19f0v85");
    			add_location(p0, file$1, 6, 4, 76);
    			attr_dev(div0, "class", "text svelte-19f0v85");
    			add_location(div0, file$1, 5, 4, 52);
    			attr_dev(p1, "class", "orange svelte-19f0v85");
    			add_location(p1, file$1, 11, 8, 181);
    			attr_dev(div1, "class", "text svelte-19f0v85");
    			add_location(div1, file$1, 10, 5, 153);
    			attr_dev(div2, "class", "version svelte-19f0v85");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(source, file, 12, 8, 382);
    			...
    			add_location(video, file, 11, 6, 303);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Heropage, Projects, Footer, Versiondiv });
    	return [];
    }
