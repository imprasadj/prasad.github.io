    ...
    function create_default_slot_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-5gifqt");
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "iconsA svelte-5gifqt");
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			create_component(icon2.$$.fragment);
    			attr_dev(div, "class", "iconsB svelte-5gifqt");
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "icons svelte-5gifqt");
    			add_location(div, file$2, 16, 4, 920);
    			attr_dev(section, "class", "tech svelte-5gifqt");
