    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-j9cmg");
    			add_location(h2, file$3, 16, 4, 317);
    			attr_dev(h10, "class", "svelte-j9cmg");
    			add_location(h10, file$3, 23, 16, 563);
    			attr_dev(h11, "class", "svelte-j9cmg");
    			add_location(h11, file$3, 24, 16, 592);
    			attr_dev(h30, "class", "svelte-j9cmg");
    			add_location(h30, file$3, 25, 16, 624);
    			attr_dev(a0, "href", "/");
    			attr_dev(a0, "class", "svelte-j9cmg");
    			add_location(a0, file$3, 26, 16, 662);
    			attr_dev(div0, "class", "text svelte-j9cmg");
    			attr_dev(div0, "data-aos", "fade-up");
    			attr_dev(div0, "data-aos-duration", "500");
    			attr_dev(div0, "data-aos-anchor-placement", "bottom-bottom");
    			add_location(div0, file$3, 22, 12, 442);
    			attr_dev(div1, "class", "textcontainer svelte-j9cmg");
    			add_location(div1, file$3, 21, 8, 401);
    			attr_dev(div2, "class", "container1 svelte-j9cmg");
    			add_location(div2, file$3, 20, 4, 367);
    			attr_dev(h12, "class", "svelte-j9cmg");
    			add_location(h12, file$3, 33, 16, 941);
    			attr_dev(h13, "class", "svelte-j9cmg");
    			add_location(h13, file$3, 34, 16, 970);
    			attr_dev(h31, "class", "svelte-j9cmg");
    			add_location(h31, file$3, 35, 16, 1002);
    			attr_dev(a1, "href", "/");
    			attr_dev(a1, "class", "svelte-j9cmg");
    			add_location(a1, file$3, 36, 16, 1040);
    			attr_dev(div3, "class", "text svelte-j9cmg");
    			attr_dev(div3, "data-aos", "fade-up");
    			attr_dev(div3, "data-aos-duration", "500");
    			attr_dev(div3, "data-aos-anchor-placement", "bottom-bottom");
    			add_location(div3, file$3, 32, 12, 820);
    			attr_dev(div4, "class", "textcontainer svelte-j9cmg");
    			add_location(div4, file$3, 31, 8, 779);
    			attr_dev(div5, "class", "container2 svelte-j9cmg");
    			add_location(div5, file$3, 30, 4, 745);
    			attr_dev(h14, "class", "svelte-j9cmg");
    			add_location(h14, file$3, 43, 16, 1319);
    			attr_dev(h15, "class", "svelte-j9cmg");
    			add_location(h15, file$3, 44, 16, 1348);
    			attr_dev(h32, "class", "svelte-j9cmg");
    			add_location(h32, file$3, 45, 16, 1379);
    			attr_dev(a2, "href", "/");
    			attr_dev(a2, "class", "svelte-j9cmg");
    			add_location(a2, file$3, 46, 16, 1417);
    			attr_dev(div6, "class", "text svelte-j9cmg");
    			attr_dev(div6, "data-aos", "fade-up");
    			attr_dev(div6, "data-aos-duration", "500");
    			attr_dev(div6, "data-aos-anchor-placement", "bottom-bottom");
    			add_location(div6, file$3, 42, 12, 1198);
    			attr_dev(div7, "class", "textcontainer svelte-j9cmg");
    			add_location(div7, file$3, 41, 8, 1157);
    			attr_dev(div8, "class", "container3 svelte-j9cmg");
    			add_location(div8, file$3, 40, 4, 1123);
    			attr_dev(section, "class", "projects svelte-j9cmg");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-1hnizza");
    			add_location(span, file$1, 7, 8, 109);
    			attr_dev(p0, "class", "svelte-1hnizza");
    			add_location(p0, file$1, 6, 4, 76);
    			attr_dev(div0, "class", "text svelte-1hnizza");
    			add_location(div0, file$1, 5, 4, 52);
    			attr_dev(p1, "class", "orange svelte-1hnizza");
    			add_location(p1, file$1, 11, 8, 181);
    			attr_dev(div1, "class", "text svelte-1hnizza");
    			add_location(div1, file$1, 10, 5, 153);
    			attr_dev(div2, "class", "version svelte-1hnizza");
