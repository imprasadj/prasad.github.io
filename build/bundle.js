    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img1, file$5, 26, 12, 717);
    			attr_dev(div3, "class", "image");
    			add_location(div3, file$5, 25, 12, 684);
    			attr_dev(h41, "class", "svelte-1nzjwyk");
    			add_location(h41, file$5, 30, 12, 842);
    			attr_dev(p1, "class", "svelte-1nzjwyk");
    			add_location(p1, file$5, 31, 12, 895);
    			attr_dev(div4, "class", "title svelte-1nzjwyk");
    			add_location(div4, file$5, 29, 12, 809);
    			attr_dev(a0, "href", "https://www.behance.net/gallery/124483607/Animal-Rescue-Webapp-redesign");
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "class", "svelte-1nzjwyk");
    			add_location(a0, file$5, 24, 12, 572);
    			attr_dev(div5, "class", "card svelte-1nzjwyk");
    			add_location(div5, file$5, 23, 8, 540);
    			...
    			add_location(img2, file$5, 39, 12, 1069);
    			attr_dev(div6, "class", "image");
    			add_location(div6, file$5, 38, 12, 1036);
    			attr_dev(h42, "class", "svelte-1nzjwyk");
    			add_location(h42, file$5, 43, 12, 1195);
    			attr_dev(p2, "class", "svelte-1nzjwyk");
    			add_location(p2, file$5, 44, 12, 1224);
    			attr_dev(div7, "class", "title svelte-1nzjwyk");
    			add_location(div7, file$5, 42, 12, 1162);
    			attr_dev(a1, "href", "/");
    			attr_dev(a1, "class", "svelte-1nzjwyk");
    			add_location(a1, file$5, 37, 12, 1010);
    			attr_dev(div8, "class", "card svelte-1nzjwyk");
    			add_location(div8, file$5, 36, 8, 978);
