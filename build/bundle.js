    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p2 = element("p");
    			p2.textContent = "3D";
    			attr_dev(h2, "class", "svelte-18319fm");
    			add_location(h2, file$4, 8, 4, 98);
    			...
    			attr_dev(img0, "class", "svelte-18319fm");
    			add_location(img0, file$4, 14, 8, 222);
    			attr_dev(div0, "class", "image");
    			add_location(div0, file$4, 13, 8, 193);
    			attr_dev(h40, "class", "svelte-18319fm");
    			add_location(h40, file$4, 18, 12, 363);
    			attr_dev(p0, "class", "svelte-18319fm");
    			add_location(p0, file$4, 19, 12, 438);
    			attr_dev(div1, "class", "title svelte-18319fm");
    			add_location(div1, file$4, 17, 8, 330);
    			attr_dev(div2, "class", "card svelte-18319fm");
    			add_location(div2, file$4, 12, 4, 165);
    			if (img1.src !== (img1_src_value = "/resq3.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "RESQ UI/UX by Prasad Jadhav");
    			attr_dev(img1, "class", "svelte-18319fm");
    			add_location(img1, file$4, 25, 8, 543);
    			attr_dev(div3, "class", "image");
    			add_location(div3, file$4, 24, 8, 514);
    			attr_dev(h41, "class", "svelte-18319fm");
    			add_location(h41, file$4, 29, 8, 656);
    			attr_dev(p1, "class", "svelte-18319fm");
    			add_location(p1, file$4, 30, 8, 705);
    			attr_dev(div4, "class", "title svelte-18319fm");
    			add_location(div4, file$4, 28, 8, 627);
    			attr_dev(div5, "class", "card svelte-18319fm");
    			add_location(div5, file$4, 23, 4, 486);
    			if (img2.src !== (img2_src_value = "/aliens.png")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "RESQ UI/UX by Prasad Jadhav");
    			attr_dev(img2, "class", "svelte-18319fm");
    			add_location(img2, file$4, 36, 8, 815);
    			attr_dev(div6, "class", "image");
    			add_location(div6, file$4, 35, 8, 786);
    			attr_dev(h42, "class", "svelte-18319fm");
    			add_location(h42, file$4, 40, 8, 929);
    			attr_dev(p2, "class", "svelte-18319fm");
    			add_location(p2, file$4, 41, 8, 954);
    			attr_dev(div7, "class", "title svelte-18319fm");
    			add_location(div7, file$4, 39, 8, 900);
    			attr_dev(div8, "class", "card svelte-18319fm");
    			add_location(div8, file$4, 34, 4, 758);
    			attr_dev(div9, "class", "cardwrapper svelte-18319fm");
    			add_location(div9, file$4, 10, 4, 132);
    			attr_dev(section, "class", "projects svelte-18319fm");
    			add_location(section, file$4, 7, 0, 66);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "gradient svelte-dhsl60");
    			add_location(h1, file$3, 11, 8, 219);
    			attr_dev(h3, "class", "svelte-dhsl60");
    			add_location(h3, file$3, 16, 8, 347);
    			attr_dev(button, "class", "svelte-dhsl60");
    			add_location(button, file$3, 23, 8, 606);
    			attr_dev(section, "class", "hero svelte-dhsl60");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "socials svelte-1owb8ds");
    			add_location(div0, file$2, 6, 8, 108);
    			attr_dev(div1, "class", "socials svelte-1owb8ds");
    			add_location(div1, file$2, 9, 8, 220);
    			attr_dev(div2, "class", "socials svelte-1owb8ds");
    			add_location(div2, file$2, 12, 8, 343);
    			attr_dev(div3, "class", "footer svelte-1owb8ds");
